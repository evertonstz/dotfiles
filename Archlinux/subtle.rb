...
screen 1 do
  top    [ :views, :mpd, :spacer, :keychain, :tray, :separator, :cpu, :separator, :battery, :separator, :clock ]
  bottom [ ]
end
...
grab "W-C-f", "firefox"
grab "W-C-t", "thunar"
grab "W-C-v", "virtualbox"
grab "W-C-j", "jumanji"
grab "W-C-a", "urxvt -e alsamixer"
grab "C-space", "dmenu_run -p 'Arch Linux' -fn '-*-terminus-*-*-*-11-*-*-*-*-*-*-*' -nf '#4F4F4F' -nb '#363636' -sf '#FFA500' -sb '#4F4F4F'"
grab "W-C-l", "xscreensaver-command -lock"
...
#                more tham one. Matching works either via plaintext, regex
...
tag "browser", 	"uzbl|opera|firefox|navigator|jumanji|xterm"
tag "file",	"pcmanfm|thunar|vlc"
tag "media",	"banshee"
tag "vbox", "virtualbox"
tag "alsa", "urxvt -e alsamixer"
...
#space = {
#  :terms => Subtlext::Icon.new("#{iconpath}/terminal.xbm"),
#  :www => Subtlext::Icon.new("#{iconpath}/fox.xbm"),
#  :gimp => Subtlext::Icon.new("#{iconpath}/paint.xbm"),
#  :dev => Subtlext::Icon.new("#{iconpath}/cert.xbm"),
#  :file => Subtlext::Icon.new("#{iconpath}/diskette.xbm"),
#  :doc => Subtlext::Icon.new("#{iconpath}/file2.xbm"),
#  :vbox => Subtlext::Icon.new("#{iconpath}/tv.xbm")
#  
#}

view "term" do
  match "urxvt|urxvt2|urxvt3"
...
view "media" do
  match "media"
  icon Subtlext::Icon.new("#{iconpath}/headphones.xbm")
  icon_only icons
end

view "file" do
  match "file"
  icon Subtlext::Icon.new("#{iconpath}/diskette.xbm")
  icon_only icons
end
...
on :start do
            Subtlext::Subtle.spawn "urxvt"
                    Subtlext::Subtle.spawn "urxvt -rv -name urxvt2"
                            Subtlext::Subtle.spawn "urxvt -rv -name urxvt3"
end

on :start do
   Subtlext::Subtle.spawn "volti"
end
...
on :start do
   Subtlext::Subtle.spawn "emesene"
end

on :start do
   Subtlext::Subtle.spawn "xscreensaver -no-splash"
end
